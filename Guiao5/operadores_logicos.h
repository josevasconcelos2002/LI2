...
/**
 *\brief Esta é a função responsável por utilizar o operador lógico "não" do elemento que se econtra no topo da stack.
 *
 *@param s stack onde retiramos os valores e colocamos o resultado.
 *@param token que verifica se o que o utilizador introduz é igual ao símbolo responsável pela operação lógica em questão.
 * 
...
/**
 *\brief Esta é a função responsável por utilizar o operador lógico "e(com shortcut)" dos dois elementos que se encontram no topo da stack. 
 *
 *@param s stack onde retiramos os valores e colocamos o resultado.
 *@param token que verifica se o que o utilizador introduz é igual ao símbolo responsável pela operação lógica em questão.
 * 
...
/**
 *\brief Esta é a função responsável por utilizar o operador lógico "ou(com shortcut)" dos dois elementos que se encontram no topo da stack.
 *
 *@param s stack onde retiramos os valores e colocamos o resultado.
 *@param token que verifica se o que o utilizador introduz é igual ao símbolo responsável pela operação lógica em questão.
 * 
...
/**
 *\brief Esta é a função responsável por utilizar o operador lógico "if then else" dos três elementos que se encontram no topo da stack.
 *
 *@param s stack onde retiramos os valores e colocamos o resultado.
 *@param token que verifica se o que o utilizador introduz é igual ao símbolo responsável pela operação lógica em questão.
 * 
